import {
  ...
  TextField,
  Select,
} from "@shopify/polaris"; // Import TextField and Select
...
function ColorSettingItem({
  ...
  const checkerboardStyle = {
    backgroundImage:
      'url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEWysrKz+9lRAAAACklEQVQI12MAAgAABAABINZymAAAAABJRU5ErkJggg==")',
...
function DesignSettings({
  ...
  const handleSwatchClick = useCallback(
    (settingKey) => setOpenColorPickerFor(settingKey),
    [],
  );
              ...
              <Grid columns={{ xs: 1, sm: 2, md: 2, lg: 2, xl: 2 }} gap={400}>
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleBackgroundColorChange("bundle", color)
                    }
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleBackgroundColorChange("border", color)
                    }
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleBackgroundColorChange("checkmark", color)
                    }
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleBackgroundColorChange("highlight", color)
                    }
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleBackgroundColorChange("selectedBundle", color)
                    }
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleBackgroundColorChange("borderSelectedBundle", color)
                    }
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleBackgroundColorChange("tags", color)
                    }
              ...
              <Grid columns={{ xs: 1, sm: 2, md: 2, lg: 2, xl: 2 }} gap={400}>
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handlePricingColorChange("price", color)
                    }
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handlePricingColorChange("comparedPrice", color)
                    }
              ...
              <Grid columns={{ xs: 1, sm: 2, md: 2, lg: 2, xl: 2 }} gap={400}>
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleTextColorChange("subtitle", color)
                    }
                ...
                <Grid.Cell>
                  <ColorSettingItem
                    ...
                    onChange={(color) =>
                      handleTextColorChange("highlight", color)
                    }
                  ...
                  >
                    <Grid.Cell>
                      <TextField
                        ...
                        onChange={(value) =>
                          handleTypographyChange("header", "size", value)
                        }
                        type="number"
                        min={0}
                        autoComplete="off"
                    ...
                    <Grid.Cell>
                      <Select
                        ...
                        onChange={(value) =>
                          handleTypographyChange("header", "fontStyle", value)
                        }
                  ...
                  >
                    <Grid.Cell>
                      <TextField
                        ...
                        onChange={(value) =>
                          handleTypographyChange("titlePrice", "size", value)
                        }
                        type="number"
                        min={0}
                        autoComplete="off"
                  ...
                  >
                    ...
                    <Grid.Cell>
                      <Select
                        ...
                        value={
                          typographySettings.subtitleComparedPrice.fontStyle
                        }
                      />
                    </Grid.Cell>
                  </Grid>
                  ...
                  >
                    <Grid.Cell>
                      <TextField
                        ...
                        onChange={(value) =>
                          handleTypographyChange("tagHighlight", "size", value)
                        }
                        type="number"
                        min={0}
                        autoComplete="off"
